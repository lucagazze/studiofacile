...
(function () {
  ...
  var LIBRI = {
    ...
    ecg_fr: {
      ...
      pagine: [
        ['ecg_fr_02', 'Les ondes et les intervalles'],
        ['ecg_fr_03', 'La méthode en huit étapes'],
        ['ecg_fr_04', 'La fibrillation atriale'],
        ['ecg_fr_05', 'Rythmes choquables et non choquables']
      ]
    },
    ecg: {
    ...
    fisica: {
      ...
      pagine: [
        ['fisica_libro_01', 'Accelerazione e caduta libera'],
        ['fisica_libro_02', 'Bernoulli: stenosi e aneurisma'],
        ['fisica_libro_03', 'L’effetto Doppler'],
    ...
    ov.innerHTML =
      '<div class="gal-box">' +
        '<div class="gal-head">' +
          ...
          '<button class="gal-x" type="button" aria-label="' + (FR ? 'Fermer' : 'Chiudi') + '">&times;</button>' +
        '</div>' +
  ...
  function open(slug) {
    ...
    elTit.innerHTML = '';
    elTit.appendChild(document.createTextNode((FR ? 'Aperçu : ' : 'Anteprima: ') + libro.titolo));
